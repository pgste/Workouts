...
import Block from './screens/Block.jsx';
...
const TABBED = ['blocks', 'block', 'week', 'court', 'daily', 'progress'];
...
function currentScreen(state, block, week, day) {
...
export default function App() {
  const { state, block, week, day } = useTracker();
  const screen = currentScreen(state, block, week, day);
